...
const FAQ = () => {
  ...
  return (
    <section className="bg-white p-10 max-w-[1440px] w-full mx-auto">
      <h2 className="text-2xl font-bold text-center text-indigo-600">Frequently Asked Questions</h2>
        ...
        {[  
          ...
          <div
            ...
            className={`p-4 rounded-lg cursor-pointer border transition-all ${
              openIndex === index ? "bg-indigo-50 border-indigo-600" : "bg-gray-100 border-gray-300"
            }`}
          ...
          >
            <div className="flex justify-between items-center">
              <p className={`font-semibold transition ${openIndex === index ? "text-indigo-600" : "text-gray-900"}`}>
                {faq.question}
              </p>
