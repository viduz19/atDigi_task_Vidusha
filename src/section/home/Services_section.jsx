    ...
    <section className="p-10 max-w-[1440px] bg-white mx-auto">
      <div className="flex flex-col space-y-16 items-center w-full">
        ...
        <div className="flex flex-col md:flex-row items-center max-w-8xl w-full gap-10 px-6 md:px-12">
          <img src={webAppImage} alt="Web & Mobile App Development" className="w-48 md:w-auto" />
          <div className="md:w-2/3 space-y-4 text-center md:text-left">
            <h2 className="text-2xl font-bold text-indigo-600">Web & Mobile App Development</h2>
            ...
            <button className="mt-4 bg-orange-500 px-6 py-3 text-white font-bold rounded-md hover:bg-orange-600 transition-all">
              LEARN MORE
            </button>
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row-reverse items-center max-w-8xl w-full gap-10 px-6 md:px-12">
          <img src={strategyImage} alt="Digital Strategy Consulting" className="w-48 md:w-auto" />
          <div className="md:w-2/3 text-center md:text-left space-y-4">
            <h2 className="text-2xl font-bold text-indigo-600">Digital Strategy Consulting</h2>
            <p className="text-gray-700">
